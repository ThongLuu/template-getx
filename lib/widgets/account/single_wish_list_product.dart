...
import '../../../../widgets/common_widgets/stars.dart';
...
class SingleWishListProduct extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return GestureDetector(
      onTap: () {
        Get.toNamed(Routes.PRODUCTDETAILSSCREENROUTE, arguments: {
          "product": product,
                    ...
                    Row(
                      children: [
                        Expanded(
                          child: TextButton(
                              onPressed: () {
                                controllerWishList.addToCartFromWishList(
                                    product: product!);
                              },
                        ...
                        IconButton(
                          onPressed: () {
                            controllerWishList.removedFromWishListScreen(
                                product: product!);
                          },
